...
public class SecSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(final WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/resources/**", "/webjars/**", "/email_templates/**", "/img/**", "/images/**", "/contactform/**", "/fonts/**", "/ico/**", "/css/**", "/vendor/**", "/js/**", "/assets/**", "/node_modules/**", "/wp-conten/**", "/wp-includes/**", "/registration/**", "/Secretaire/**", "/Client/**", "/Avocat/**", "/bureau/**");
    }
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/Admin/**", "/Avocat/**", "/Secretaire/**").hasRole("ADMIN")
