...
// Role for Admin_Application
        final List<Privilege> adminAppPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, writePrivilege, passwordPrivilege));
        final Role adminAppRole = createRoleIfNotFound("ROLE_ADMIN_APPLICATION", adminAppPrivileges);

// Role for Admin_Avocat
        final List<Privilege> adminAvocatPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, writePrivilege, passwordPrivilege));
        final Role adminAvocatRole = createRoleIfNotFound("ROLE_ADMIN_AVOCAT", adminAvocatPrivileges);
...
// Role for Client
       ...
       // createUserIfNotFound("salim@gmail.com", "soulayman","9ala", "1234", new ArrayList<Role>(Arrays.asList(UserRole)));
        ...
        createUserIfNotFound("admin_app@example.com", "Admin", "Application", "adminpassword", new ArrayList<Role>(Arrays.asList(adminAppRole)));
        createUserIfNotFound("admin_avocat@example.com", "Admin", "Avocat", "adminpassword", new ArrayList<Role>(Arrays.asList(adminAvocatRole)));
